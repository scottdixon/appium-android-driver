...
class AndroidDriver extends BaseDriver {
  ...
  async startChromeSession () {
    ...
    let opts = {
      ...
      executable: this.opts.chromedriverExecutable,
      chromeUseRunningApp: false,
      enablePerformanceLogging: this.opts.enablePerformanceLogging
    };
    ...
    if (_.contains(knownPackages, this.opts.appPackage)) {
      opts.appPackage = this.opts.appPackage;
    } else {
